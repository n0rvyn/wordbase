...
4. Confirm the post is published and report the rebuild status (call `build_status` once to show it kicked off). If you need to force a fresh build, hand off to `wb-rebuild`.
