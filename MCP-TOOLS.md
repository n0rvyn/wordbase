...
> Source: `packages/api/src/mcp/tools.ts` · MCP server `wordbase-blog` v1.0.0 · 2026-06-03

**43 tools** across 4 groups.
...
- **Podcast** (12): `podcast_list_shows` · `podcast_create_show` · `podcast_publish_show` · `podcast_list_episodes` · `podcast_analytics` · `podcast_create_episode` · `podcast_upload_audio` · `podcast_publish_episode` · `podcast_update_show` · `podcast_update_episode` · `podcast_import_feed` · `podcast_upload_audio_from_url`
