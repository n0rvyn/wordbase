...
- **Podcast** (11): `podcast_list_shows` · `podcast_create_show` · `podcast_publish_show` · `podcast_list_episodes` · `podcast_create_episode` · `podcast_upload_audio` · `podcast_publish_episode` · `podcast_update_show` · `podcast_update_episode` · `podcast_import_feed` · `podcast_upload_audio_from_url`
...
| `podcastId` |  | Target show ID to import into; if omitted, a new show is created |
